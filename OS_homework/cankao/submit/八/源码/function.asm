...
extrn _loadErrorMsg:near
extrn _loadSuccessMsg:near
...
_setTimer proc
	...
	mov ax,14914                ; 1193182/59660=20次
	out 40h, al
	mov al, ah
	out 40h,al
	pop ax
